      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold text-indigo-400 mb-4">PsiConecta</h3>
            <p className="text-gray-300 mb-4">
              Conectando você aos melhores profissionais de psicologia do Brasil.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Especialistas</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">contato@psiconecta.com.br</li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400">
          <p>© 2025 PsiConecta. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
